...
<form>
            ...
            <div class="form-group">
                <label for="id_patent_issuing_date">Patent issuing date</label>
                        <input class="form-control" id="id_patent_issuing_date" name="patent_issuing_date" type="date">
            </div>
            ...
            <div class="form-group">
                <label for="id_application_date">Application date</label>
                        <input class="form-control" id="id_application_date" name="application_date" type="date">
                        <p class="help-block"><small>For pending patents</small></p>
            </div>
