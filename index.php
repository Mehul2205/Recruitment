...
$email_error="";
    ...
    if(isset($_POST['fname']))
    {
        ...
        if($a)
        {
          ...
          $sql="INSERT INTO details (firstname, middlename, lastname, dob, gender, category, res_category, email, phone, password,department,post,reg_no) VALUES ( '".$_POST['fname']."','".$_POST['mname']."','".$_POST['lname']."','".$_POST['dob']."','".$_POST['gender']."','".$_POST['cat']."','".$_POST['res_cat']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['pass']."','".$_POST['department']."','".$_POST['post']."','".$regno."');";
//        echo $sql;
